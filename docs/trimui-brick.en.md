...
Cursed Drone 0.12.3 is verified on TrimUI Brick with **Knulli/PortMaster** and **NextUI**. Knulli uses `/userdata/roms/ports/Cursed Drone.sh`; NextUI uses `Tools/tg5040/Cursed Drone.pak/launch.sh`. The packages are not interchangeable.
