...
Cursed Drone 0.13.0 is verified on TrimUI Brick with **Knulli/PortMaster** and **NextUI**. Knulli uses `/userdata/roms/ports/Cursed Drone.sh`; NextUI uses `Tools/tg5040/Cursed Drone.pak/launch.sh`. The packages are not interchangeable.
